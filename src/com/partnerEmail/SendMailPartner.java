...
import com.mail.FromMail;

/**
 * Servlet implementation class SendMailPartner
 */
@WebServlet("/SendMailPartner")
public class SendMailPartner extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//6자리 인증번호 생성
		String localhost = "http://localhost:8097/weats/";
		...
		String content = "다음 링크에 접속하여 이메일 인증  "
						+ "<a href='"+localhost+"EmailCheckPartner?code="+code+"'>이메일 인증하기</a>" ;
		 ...
		 try{
		     ...
		     response.sendRedirect("partner/PartnerMailCheck.jsp");
