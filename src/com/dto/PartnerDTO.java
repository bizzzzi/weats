...
public class PartnerDTO {
	...
	public PartnerDTO(String partner_id, String user_id, String c_name, String c_postnum, String c_address,
			String c_phone, String partner_license_num, String partner_license_docs) {
		super();
	...
	public String toString() {
		return "PartnerDTO [partner_id=" + partner_id + ", user_id=" + user_id + ", c_name=" + c_name + ", c_postnum="
				+ c_postnum + ", c_address=" + c_address + ", c_phone=" + c_phone + ", partner_license_num="
				+ partner_license_num + ", partner_license_docs=" + partner_license_docs + "]";
	}
